            ...
            rewards.forEach(reward => {
                ...
                card.innerHTML = `
                    <div class="p-3">
                        ...
                        <h4 class="font-bold text-[13px] text-gray-900 dark:text-white line-clamp-2 leading-tight min-h-[2.5rem]">${reward.name}</h4>
                        ...
                        <button onclick="redeemReward('${reward.id}', '${reward.name.replace(/'/g, "\\'")}', ${reward.points_required})"
